...
Romance.onLoad = function () {
	...
	Romance.handleKeyDownEvents();
};

// called when application has closed
Romance.onUnload = function () {
	console.log("Romance.onUnload()");
};
	
	
//Romance
var responseUrl = "https://api.aniapi.com/v1/anime?&genres=Romance";
fetch(responseUrl, {
	  method: "GET",
	...
	teste = json.data.documents;
	 ...
	 for(var i = 0; i < teste.length; i=i+4){    
  	   ...
  	   <div class="col-lg-3">
  		...
  		document.getElementById("lista_romance").appendChild(div); //adicionando imagem como filha de demo
...
Romance.handleKeyDownEvents = function () {
...
//binding some events
window.onload = Romance.onLoad;
window.onunload = Romance.onUnload;
